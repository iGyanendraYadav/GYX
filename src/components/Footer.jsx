...
const Footer = () => {
  return (
    <div className="flex items-end w-full h-auto bg-white font-poppins">
      <footer className="w-full text-gray-700 bg-gray-100 body-font">
        <div className="container flex flex-col flex-wrap px-5 py-10 lg:py-16 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
